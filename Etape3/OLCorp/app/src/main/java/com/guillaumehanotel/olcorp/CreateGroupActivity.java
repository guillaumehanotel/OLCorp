...
public class CreateGroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // LISTE DES NOMS DES OU

        ArrayList<String> organizationUnits_name = new ArrayList<>();
        for (OrganizationUnit ou : list_ou){
            organizationUnits_name.add(ou.getName());
        }
    ...
    private void createGroup(OrganizationUnit organizationUnit, Group group){
        ...
        Log.d("DEBUG", String.valueOf(organizationUnit.getId()));
        Log.d("DEBUG", String.valueOf(group));
